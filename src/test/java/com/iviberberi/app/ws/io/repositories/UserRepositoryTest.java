...
class UserRepositoryTest {
    ...
    private void createRecords()
    {
        ...
        userEntity.setFirstName("Ivi");
        userEntity.setLastName("Berberi");
        ...
        userEntity2.setFirstName("Ivi");
        userEntity2.setLastName("Berberi");
